...
class Bundler extends EventEmitter {
    ...
    return _asyncToGenerator(function*() {
      ...
      try {
        ...
        if (_this2.hmr && !isInitialBundle) {
          _this2.hmr.emitUpdate([
            ..._this2.findOrphanAssets(),
            ...loadedAssets
          ]);
        }
  ...
  loadAsset(asset) {
    ...
    return _asyncToGenerator(function*() {
      ...
      if (!processed || asset.shouldInvalidate(processed.cacheData)) {
        processed = yield _this8.farm.run(
          asset.name,
          asset.package,
          _this8.options
        );
  ...
  createBundleTree(asset, dep, bundle, parentBundles = new Set()) {
    ...
    try {
      for (
        var _iterator2 = asset.depAssets[Symbol.iterator](), _step2;
  ...
  moveAssetToBundle(asset, commonBundle) {
    ...
    try {
      for (
        var _iterator3 = Array.from(asset.bundles)[Symbol.iterator](), _step3;
  ...
  *findOrphanAssets() {
    ...
    try {
      for (
        var _iterator5 = this.loadedAssets.values()[Symbol.iterator](), _step5;
  ...
  unloadOrphanedAssets() {
    ...
    try {
      for (
        var _iterator6 = this.findOrphanAssets()[Symbol.iterator](), _step6;
  ...
  unloadAsset(asset) {
    ...
    if (this.watcher) {
      ...
      try {
        for (
          var _iterator7 = asset.dependencies.values()[Symbol.iterator](),
            _step7;
  ...
  onChange(path) {
    ...
    return _asyncToGenerator(function*() {
      ...
      try {
        for (
          var _iterator8 = assets[Symbol.iterator](), _step8;
      ...
      _this9.rebuildTimeout = setTimeout(
